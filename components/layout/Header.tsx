  ...
  return (
    <header className="bg-white shadow-[0_4px_15px_rgba(0,0,0,0.06)] sticky top-0 z-[999] px-[5%] py-[10px]">
      <div className="max-w-[1400px] mx-auto flex justify-between items-center gap-[20px]">
        ...
        <nav className={`${isMobileMenuOpen ? 'block absolute top-full left-0 w-full bg-white shadow-md border-t-[2px] border-[#E2E8F0] p-0' : 'hidden'} md:flex md:static md:w-auto md:bg-transparent md:shadow-none md:border-none md:p-0 flex-grow justify-center`}>
          <ul className="flex flex-col md:flex-row list-none gap-0 md:gap-[25px] m-0 p-0 w-full md:w-auto">
            
            <li className="w-full md:w-auto border-b md:border-none border-[#E2E8F0]">
              <a href="#" className="flex justify-between items-center text-[#334155] no-underline font-semibold text-[0.95rem] py-[15px] px-[20px] md:px-[5px] hover:text-[#005FA3] transition-colors">
                Início
              </a>
            </li>
            ...
            <li className="w-full md:w-auto border-b md:border-none border-[#E2E8F0] group relative">
              <a href="#" className="flex justify-between items-center text-[#334155] no-underline font-semibold text-[0.95rem] py-[15px] px-[20px] md:px-[5px] hover:text-[#005FA3] transition-colors">
                Chã Grande <i className="fas fa-chevron-down text-[0.7rem] text-[#005FA3] group-hover:rotate-180 md:group-hover:rotate-0 transition-transform"></i>
              </a>
            ...
            <li className="w-full md:w-auto border-b md:border-none border-[#E2E8F0] group relative">
              <a href="#" className="flex justify-between items-center text-[#334155] no-underline font-semibold text-[0.95rem] py-[15px] px-[20px] md:px-[5px] hover:text-[#005FA3] transition-colors">
                Governo <i className="fas fa-chevron-down text-[0.7rem] text-[#005FA3] group-hover:rotate-180 md:group-hover:rotate-0 transition-transform"></i>
              </a>
              <ul className="hidden group-hover:flex flex-col md:absolute top-full left-0 bg-[#F1F5F9] md:bg-white min-w-[220px] md:shadow-[0_10px_25px_rgba(0,0,0,0.08)] rounded-none md:rounded-[8px] list-none p-0 md:py-[10px] z-[1000] border-none md:border-t-[3px] md:border-[#005FA3]">
            ...
            <li className="w-full md:w-auto border-b md:border-none border-[#E2E8F0] group relative">
              <a href="#" className="flex justify-between items-center text-[#334155] no-underline font-semibold text-[0.95rem] py-[15px] px-[20px] md:px-[5px] hover:text-[#005FA3] transition-colors">
                Serviços <i className="fas fa-chevron-down text-[0.7rem] text-[#005FA3] group-hover:rotate-180 md:group-hover:rotate-0 transition-transform"></i>
              </a>
              <ul className="hidden group-hover:flex flex-col md:absolute top-full left-0 bg-[#F1F5F9] md:bg-white min-w-[220px] md:shadow-[0_10px_25px_rgba(0,0,0,0.08)] rounded-none md:rounded-[8px] list-none p-0 md:py-[10px] z-[1000] border-none md:border-t-[3px] md:border-[#005FA3]">
